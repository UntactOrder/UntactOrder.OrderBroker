...
from console_api import log
from dataclass_menus import MenuList
from dataclass_orders import OrderList
from network_session import sokt_close
from network_session import send_continually
from network_session import recv_continually
from network_application import get_request
from network_application import process_request
...
class CustomerGroup(dict):
    ...
    _LOCATION = "res/data/tables.untactorder.db"
